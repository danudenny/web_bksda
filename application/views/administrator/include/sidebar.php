        ...
        <li class="nav-header">MAIN MENU</li>
          ...
          <li class="nav-item has-treeview">
            ...
            <?php
              ...
              $cek=$this->model_app->umenu_akses("linkskpd",$this->session->id_session);
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/linkskpd'><i class='far fa-circle nav-icon text-success'></i> <p>Link SKPD</p></a></li>";
              }
          ...
          <!-- <li class="nav-item has-treeview">
            ...
            <p>Modul Gambar <i class="right fas fa-angle-left"></i></p></a>
            <ul class="nav nav-treeview">
            <?php
              $cek=$this->model_app->umenu_akses("gambaratas",$this->session->id_session);
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/gambaratas'><i class='far fa-circle nav-icon text-success'></i> <p>Gambar Atas</p></a></li>";
              }

              $cek=$this->model_app->umenu_akses("gambarhome",$this->session->id_session);
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/gambarhome'><i class='far fa-circle nav-icon text-success'></i> <p>Gambar Home</p></a></li>";
              }

              $cek=$this->model_app->umenu_akses("gambarsidebar",$this->session->id_session);
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/gambarsidebar'><i class='far fa-circle nav-icon text-success'></i> <p>Gambar Sidebar</p></a></li>";
              }

              $cek=$this->model_app->umenu_akses("banner",$this->session->id_session);
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/banner'><i class='far fa-circle nav-icon text-success'></i> <p>Gambar Link</p></a></li>";
              }
            ?>
            </ul>
          </li> -->
