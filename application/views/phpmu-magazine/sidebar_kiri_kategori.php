...
<div class='block'>
	<div class='banner'>";
		$pasanggambar1 = $this->model_utama->view_ordering_limit('pasanggambar','id_pasanggambar','ASC',0,1);
	  	foreach ($pasanggambar1->result_array() as $b) {
			$string = $b['gambar'];
			if ($b['gambar'] != ''){
				if(preg_match("/swf\z/i", $string)) {
					echo "<embed src='".base_url()."asset/foto_pasanggambar/$b[gambar]' width=250 height=200 quality='high' type='application/x-shockwave-flash'>";
				} else {
					echo "<a href='$b[url]' target='_blank'><img style='width:250px;' src='".base_url()."asset/foto_pasanggambar/$b[gambar]' alt='$b[judul]' /></a>
