	...
	<div class="single-block">
		<div class="content-block main left">
			<div class="block">
				...
				<?php
				$vdgambar = $this->model_utama->view_where_ordering_limit('gambartengah',array('posisi'=>'detail_video'),'id_gambartengah','ASC',0,5);
				foreach ($vdgambar->result_array() as $ia) {
					echo "<a href='$ia[url]' target='_blank'>";
						$string = $ia['gambar'];
						if ($ia['gambar'] != ''){
							if(preg_match("/swf\z/i", $string)) {
								echo "<embed style='margin-top:-10px' src='".base_url()."asset/foto_gambartengah/$ia[gambar]' width='100%' height=90px quality='high' type='application/x-shockwave-flash'>";
							} else {
								echo "<img style='margin-top:-10px; margin-bottom:5px' width='100%' src='".base_url()."asset/foto_gambartengah/$ia[gambar]' title='$ia[judul]' />";
							}
						}
					echo "</a>";
