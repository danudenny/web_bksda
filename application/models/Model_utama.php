...
class Model_utama extends CI_model{
    ...
    public function stat_all_sum(){
        return $this->db->query("SELECT count(*) as jumlah FROM statistik ORDER BY tanggal DESC");
    }

    public function stat_today_sum(){
        $tanggal = date("Y-m-d");
        return $this->db->query("SELECT count(*) as hits FROM statistik WHERE tanggal = '$tanggal'");
    }

    public function stat_month_sum(){
        $tanggal = date("m");
        return $this->db->query("SELECT count(*) as hits FROM statistik WHERE MONTH(tanggal) = '$tanggal'");
    }
